...
import {
  LayoutDashboard, Users, BarChart3, MessageCircle, Settings, 
...
const navigation = [
  ...
  { name: 'Contact Submissions', href: '/admin/contact', icon: MessageCircle },
      ...
      >
        <div className="flex flex-col h-full">
          ...
          <div className="flex items-center justify-center h-16 px-4 border-b border-purple-200/50 dark:border-purple-800/50">
            <Link href="/admin" className="flex items-center space-x-2" onClick={closeSidebar}>
