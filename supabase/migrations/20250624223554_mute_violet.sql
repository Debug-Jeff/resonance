/*
  # Seed Test Data for Resonance App

  1. Test User Data
    - Creates test user profile with realistic data
    - Adds mood entries for the last 7 days
    - Includes voice sessions with AI responses
    - Personal notes with journaling content
    - User settings with crisis contacts

  2. Data Relationships
    - All data properly linked to test user
    - Realistic timestamps for demo purposes
    - Varied emotional content for rich analytics

  IMPORTANT: This assumes the test user already exists in auth.users
  If not, you'll need to create the user through Supabase Auth first.
*/

-- Insert test user profile (using a realistic UUID)
